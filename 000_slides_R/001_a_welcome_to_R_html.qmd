...
-   **Installing the tidyverse as an example**
    ...
    -  Copy and paste this code in the console. The `tidyverse` package is already installed in your session so nothing will happen
    -  If you don't have installed the `tidyverse` then the package is going to be installed
