...
-   **Communication through the virtual classroom**
    ...
    -   Doubts and concerns of the topics of the course, please use the *Forum: Questions or concerns* that can be accessed at the top of the platform
        ...
        -   Talk about `reprex` and **minimal reproducible example**: [**Pending**]{style="color: red;"}
            ...
            -   Check this: https://stackoverflow.com/help/minimal-reproducible-example
...
If you use the last option remember that you are using your personal computer so depending on the specifications of your machine you will be able to use the chosen model
...
-   Quarto
    ...
    -   <https://quarto.org/>
        ...
        -   Download: <https://quarto.org/docs/download/index.html> \> Pre-release vX.X.X
