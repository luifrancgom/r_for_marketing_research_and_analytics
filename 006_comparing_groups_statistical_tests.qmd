...
$$\begin{split}
  ...
  & \mu = \mu_{11} \\
  & \alpha_1 = \beta_1 = 0 \\
  & (\alpha\beta)_{11} = (\alpha\beta)_{12} \\ 
...
$$\begin{split}
  \widehat{income}_{i} =  & \widehat{\beta}_0 + \widehat{\beta_1} Segment_i + \widehat{\beta}_2 ownHome_i + \widehat{\beta}_3 Segment_i ownHome_i + \epsilon_i \\ 
  & \text{ where } i = 1, \ldots, 300
  \end{split}$$

$$income_{i} - \widehat{income}_{i} = \widehat{\epsilon}_i \text{ where } i = 1, \ldots, 300$$
