...
params:
  ...
  schedule:
    value:
      ...
      end_virtual_meeting_hour: 09:40
...
-   Transversal learning outcomes
    ...
    -   Work collaboratively in interdisciplinary teams to meet shared objectives responsibly and respectfully.
    -   Leverage digital technologies within learning environments to optimize information access, analysis and application.
...
-   Check out all the necessary instructions in:
    ...
    -   [Primeros Pasos Marketing Research and Analytics con R y Posit Workbench](https://youtube.com/playlist?list=PLvL0Mlbw5cm28p2dL4eZhxMSv3SsIpgVy&si=dThOXEqdEC_rNfj7)
    
    -   Also you can access the [Posit Workbench UMNG Portal](https://positworkbench.umng.edu.co) using the credentials and instrucctions send to your institutional email.

## Positron

- Positron Pro and Posit Workbench

    -   [Getting Started with Positron Pro](https://docs.posit.co/ide/server-pro/user/positron/getting-started/)

- Positron user guide

    -   [Welcome to Positron](https://positron.posit.co/welcome.html)

# Use of Chat GPT, Gemini, Copilot, Claude, Deep Seek and its friends
...
-   **Ethical use**: do not present material generated by the tool as your own
...
-   Quarto
    ...
    -   <https://quarto.org/>
        ...
        -   Get started with Positron: <https://quarto.org/docs/get-started/hello/positron.html>
